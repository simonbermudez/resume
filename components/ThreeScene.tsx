...
export default function ThreeScene({ onShowFooter, onError }: ThreeSceneProps) {
    ...
    useEffect(() => {
        ...
        async function loadModels() {
            try {
                // DEBUG: Start at candle scene (index 10)
                // Calculate initial scale so candle is visible (scale ~1)
                const candleIndex = 11;
                const initialScale = MODEL_SCALE ** candleIndex;
